...
import worksEn2025 from '@/app/data/works/json/en_2024.json';
import worksZh2025 from '@/app/data/works/json/zh_2024.json';
import type { WorkItem } from '@/app/data/works/item';
import { getTranslations } from 'next-intl/server';

type WorkDict = Record<string, WorkItem>;

const Works2024Map: Record<'en' | 'zh', WorkDict> = {
  en: worksEn2025,
  zh: worksZh2025,
};
...
export default async function Works2025Page({
  ...
  const dict = Works2024Map[locale] as WorkDict;
