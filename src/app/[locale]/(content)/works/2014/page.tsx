...
import worksEn2025 from '@/app/data/works/json/en_2014.json';
import worksZh2025 from '@/app/data/works/json/zh_2014.json';
import type { WorkItem } from '@/app/data/works/item';
import { getTranslations } from 'next-intl/server';

type WorkDict = Record<string, WorkItem>;

const Works2014Map: Record<'en' | 'zh', WorkDict> = {
  en: worksEn2025,
  zh: worksZh2025,
};
...
export default async function Works2025Page({
  ...
  const dict = Works2014Map[locale] as WorkDict;
