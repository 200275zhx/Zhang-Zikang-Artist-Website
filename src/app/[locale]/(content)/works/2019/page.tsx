...
import worksEn2025 from '@/app/data/works/json/en_2019.json';
import worksZh2025 from '@/app/data/works/json/zh_2019.json';
import type { WorkItem } from '@/app/data/works/item';
import { getTranslations } from 'next-intl/server';

type WorkDict = Record<string, WorkItem>;

const Works2019Map: Record<'en' | 'zh', WorkDict> = {
  en: worksEn2025,
  zh: worksZh2025,
};
...
export default async function Works2025Page({
  ...
  const dict = Works2019Map[locale] as WorkDict;
